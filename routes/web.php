...
// google login
Route::get('/auth/google/user/redirect', [UserController::class, 'redirectToGoogle'])->middleware('guest');
Route::get('/auth/google/user/callback', [UserController::class, 'googleCallback'])->name('googleCallback');

//facebook login
Route::get('/auth/facebook/user/redirect', [UserController::class, 'redirectToFacebook'])->middleware('guest');
Route::get('/auth/facebook/user/callback', [UserController::class, 'facebookCallback'])->name('facebookCallback');

//twitter login
Route::get('/auth/twitter/user/redirect', [UserController::class, 'redirectToTwitter'])->middleware('guest');
