        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-inn-sp admin-form">
                    ...
                    <div class="tab-inn">
                        <form action="{{ route('admin.blog.form.submit') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea name="description" id="editor" class="editor" placeholder="Blog Description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
