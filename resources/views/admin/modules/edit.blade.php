                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                ...
                                <div class="tab-inn">
                                    <form action="{{ route('admin.module.update',['module' => $module]) }}" method="POST" enctype="multipart/form-data">
                                      @csrf
                                      @method('PATCH')
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" name="name" value="{{ $module->name }}" class="validate" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="module_code" value="{{ $module->module_code }}" class="validate">
                                            ...
                                            <div class="input-field col s6">
                                                <input type="text" name="credit" class="validate" value="{{ $module->credit }}">
