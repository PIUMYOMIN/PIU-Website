  ...
  <!--== breadcrumbs ==-->
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="page-back"><a href="/admin/galleries"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                                      ...
                                      @method('PATCH')
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" name="image_tag" value="{{ $gallery->image_tag }}" class="validate" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="link1" value="{{ $gallery->link1 }}" class="validate">
                                            ...
                                            <div class="input-field col s6">
                                                <input type="text" name="link2" class="validate" value="{{ $gallery->link2 }}">
                                                <label class="">Link 2</label>
                                                @error('link2')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <img
                                              ...
                                              alt="{{ $gallery->image_tag }}" width="200"
                                            />
                                        </div>
										                    <div class="row">
                                            <div class="input-field col s12">
