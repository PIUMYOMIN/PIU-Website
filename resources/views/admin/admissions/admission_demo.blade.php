                        ...
                        <div class="sb2-2-add-blog sb2-2-1">
                            ...
                            <ul class="nav nav-tabs tab-list">
                                <li class="active"><a data-toggle="tab" href="#home" aria-expanded="true"><i
                                            class="fa fa-sticky-note-o" aria-hidden="true"></i> <span>All
                                            Admissions</span></a>
                                </li>
                                ...
                                <li class=""><a data-toggle="tab" href="#menu2" aria-expanded="false"><i
                                            class="fa fa-sticky-note-o" aria-hidden="true"></i> <span>Social
                                            Sciences</span></a>
                                </li>
                                <li class=""><a data-toggle="tab" href="#menu3" aria-expanded="false"><i
                                            class="fa fa-sticky-note-o" aria-hidden="true"></i> <span>ICT</span></a>
                                </li>
                                <li class=""><a data-toggle="tab" href="#menu4" aria-expanded="false"><i
                                            class="fa fa-sticky-note-o" aria-hidden="true"></i> <span>Social</span></a>
                                </li>
                            </ul>
