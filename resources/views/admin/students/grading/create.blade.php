                                        ...
                                        <form
                                            ...
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <div class="row">
                                                        <h1 class="text-center">{{ $student->fname }}
                                                            {{ $student->lname }}</h1>
                                                    </div>
                                                </div>
                                                <div class="input-field col s12">
                                                    <div class="row">
                                                        <div class="input-field col s6">
                                                            <div class="input-field">
                                                                <input type="text" name="course_id"
                                                                    value="{{ $student->course->title }}" disabled>
                                                        ...
                                                        <div class="input-field col s6">
                                                            <select class="input-field col s12" name="module_id"
                                                                required>
                                                                <option value="" disabled selected>Module Code
                                                                </option>
                                                                @foreach ($modules as $module)
                                                                    <option {{ $module->id == old('module_id') ? 'selected' : '' }} value="{{ $module->id }}">{{ $module->module_code }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('module_id')
                                                                <p class="text-danger">{{ $message }}</p>
                                                        ...
                                                        <div class="input-field col s6">
                                                            <select class="input-field col s12" name="assignment_id"
                                                                required>
                                                                <option value="" disabled selected>Assignments
                                                                </option>
                                                                @foreach ($assignments as $assignment)
                                                                    <option {{ $assignment->id == old('assignment_id') ? 'selected' : '' }} value="{{ $assignment->id }}">{{ $assignment->name }}</option>
                                                                    @error('assignment_id')
                                                                        <p class="text-danger">{{ $message }}</p>
                                                                    @enderror
                                                                @endforeach
                                                            ...
                                                            <div class="input-field col s6">
                                                                <div class="row">
                                                                    <div class="input-field col s4">
                                                                        <input type="text" id="grade_point"
                                                                            name="grade_point" placeholder="GPA Point"
                                                                            readonly>
                                                                            @error('grade_point')
                                                                                <p class="text-danger">{{ $message }}</p>
                                                                            @enderror
