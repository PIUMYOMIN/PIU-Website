                        ...
                        <form action="{{ route('admin.partner.update',[$partner->id]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" name="name" value="{{ $partner -> name }}" class="validate"
                                        required>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" class="validate" value="{{ $partner -> web_address }}"
                                        name="web_address">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea name="description" id="editor">{{ $partner -> description }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
